...
import { sorTorles, szuresNevSzerint, tablazatRendezChar } from "./adatKezelo.js";
...
4. tablazatRendezChar(lista) - adott mező szerint rendezi a táblázatot. - akkor hívódik meg, ha a táblázat név fejlécmezőjére kattintunk. Berendezzük a listát, és megjelenítjük újra a táblázatot. 
...
function nevRendezEsemeny(lista) {
  ...
  nevELEM.on("click", function () {
    const LISTA = tablazatRendezChar(lista, nevIrany);
...
tablazatRendezChar(emberekLISTA)